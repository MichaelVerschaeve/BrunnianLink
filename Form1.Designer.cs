namespace BrunnianLink
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            cbModelChoice.Items.AddRange(new object[] { "Brunnian links", "Gosper tiling", "Hat Polykite Plates Y-scale trick", "Hat Polykite Technic", "Hilbert 3D", "Cross tiling", "Octagonal snowflake", "Penrose rhombus tiling", "Conway Radin pinwheel tiling", "Chair tiling", "Tennis tiling", "Wanderer (reflections) tiling", "Wanderer (rotations) tiling", "Ammann-Beenker tiling", "Shield tiling", "Labyrinth tiling", "Hofstetter arrowed tiling", "Wunderlich I", "Wunderlich II", "Wunderlich III" });
