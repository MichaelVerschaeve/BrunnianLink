namespace BrunnianLink
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            cbModelChoice.Items.AddRange(new object[] { "Brunnian links", "Gosper tiling", "Hat Polykite Plates Y-scale trick", "Hat Polykite Technic", "Chiral Spectre", "Hilbert 3D", "Cairo tiling", "Octagonal snowflake", "Penrose rhombus tiling", "Random Maze generator", "Cross dissection tiling", "Truchet tiling", "Conway Radin pinwheel tiling", "Chair tiling", "Domino tiling", "Domino variant (9 tiles)", "Semi Detached House", "1x2 wedge tile tiling", "penta tile tiling", "Wanderer (reflections) tiling", "Wanderer (rotations) tiling", "Ammann-Beenker tiling", "Shield tiling", "Labyrinth tiling", "Hofstetter arrowed tiling", "Wunderlich I", "Wunderlich II", "Wunderlich III", "Mini Tangram", "Socolar tiling", "Wheel tiling", "Pentomino", "Pinwheel 10", "Triangle-Square (Socolar)", "Square Triangle PinWheel Variant", "Half Hex" });
